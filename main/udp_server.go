...
// Listen will listen for incoming UDP packages on the specified address,
// and put them in the receiveHandler channel.
...
// Serve will send responses from the responseHandler channel to the clients.
